...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
		...
		<script type="text/javascript" src="<c:url value='/resources/js/google-maps-details-17-04-13.js' />"></script>
		<script type="text/javascript" src="<c:url value='/resources/js/details-17-04-13.js' />"></script>
