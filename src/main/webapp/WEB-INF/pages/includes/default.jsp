...
<html>
	<head>
	    ...
	    <link type="text/css" href="<c:url value='/resources/css/main-09-02-13.css' />" rel="stylesheet" />
	    <link type="text/css" href="<c:url value='/resources/css/detail-09-02-13.css' />" rel="stylesheet" />
	    <link type="text/css" href="<c:url value='/resources/css/registerPub-09-02-13.css' />" rel="stylesheet" />
	    <link type="text/css" href="<c:url value='/resources/css/footer-09-02-13.css' />" rel="stylesheet" />
	    <link type="text/css" href="<c:url value='/resources/css/help-09-02-13.css' />" rel="stylesheet" />
	    <link type="text/css" href="<c:url value='/resources/css/backoffice-09-02-13.css' />" rel="stylesheet" />
	    <link type="text/css" href="<c:url value='/resources/css/listPubs-09-02-13.css' />" rel="stylesheet" />
		...
		<script type="text/javascript" src="<c:url value='/resources/js/main-09-02-13.js' />"></script>