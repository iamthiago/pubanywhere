...
<html>
	<head>
	    ...
	    <link type="text/css" href="<c:url value='/resources/css/login-17-02-13.css' />" rel="stylesheet" />
	    <link type="text/css" href="<c:url value='/resources/css/user-17-02-13.css' />" rel="stylesheet" />
