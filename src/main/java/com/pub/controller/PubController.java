...
public class PubController extends UserCommons {
	...
	public String findByCountry(@PathVariable("country") String country, @PageableDefault(page = 0, sort = "rating", direction = Direction.DESC) Pageable pageable, ModelMap map, HttpServletRequest request) {
	...
	public String findAll(@PageableDefault(page = 0, sort = "rating", direction = Direction.DESC) Pageable pageable, ModelMap map, HttpServletRequest request) {
